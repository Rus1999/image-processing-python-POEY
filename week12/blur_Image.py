...
img = cv2.imread("D://workspace//python//week12//images//noise.png")
...
cv2.imwrite("D://workspace//python//week12//images//noise_after.png", bilateral_filter)
cv2.waitKey(0)
